...
export type ToolboxTarget = "health" | "startup" | "cleaner" | "backups" | "monitor" | "inventory" | "reports" | "plugins";
...
export const toolboxItems: readonly ToolboxItem[] = [
  ...
  { id: "inventory", title: t("components.softwareinventory.nav"), description: t("lib.toolbox.inventory.description"), detail: t("lib.toolbox.inventory.detail"), keywords: [t("lib.toolbox.inventory.keyword.baseline"), t("lib.toolbox.inventory.keyword.migration"), t("lib.toolbox.inventory.keyword.compare"), "json", "sha-256"], icon: Database, tone: "blue" },
