    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-700">
        <div className="relative flex-1">
          ...
          <Input
            placeholder={t("components.programlist.message_001")}
            value={searchQuery}
        ...
        >
          ...
          {metadataLoading ? t("components.programlist.message_002") : t("app.message_050")}
        </button>
      </div>
      ...
      <div className="flex-1 overflow-auto">
        {loading && visiblePrograms.length === 0 ? (
          <div className="flex items-center justify-center h-32 text-slate-500">
            ...
            {t("components.programlist.message_004")}
          </div>
        ) : error ? (
          ...
          <div className="flex flex-col items-center justify-center h-32 text-slate-500">
            ...
            <span>{t("components.programlist.message_005")}</span>
          </div>
        ) : (
      ...
      <div className="border-t border-slate-700 px-4 py-2 text-xs text-slate-500">
        ...
        {t("components.programlist.message_006")} {visiblePrograms.length}  {t("components.programlist.message_007")}
      </div>
    </div>
  );
}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs text-slate-400 truncate">
          {program.publisher ?? t("app.message_016")}{" "}
